...
func (db *Database) GetNotificationsSettings() (result bool, err error) {
	err = db.makeSelectRow(NotificationsSettings).Scan(&result)
	if err == sql.ErrNoRows {
		return result, nil
	}
	return result, err
